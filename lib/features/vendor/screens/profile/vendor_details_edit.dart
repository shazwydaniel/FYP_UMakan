...
import 'package:fyp_umakan/features/vendor/controller/update_vendor_controller.dart';
...
class VendorDetailsEdit extends StatelessWidget {
  const VendorDetailsEdit({super.key});
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Form(
                key: controller.updateVendorFormKey,
                child: Column(
                  children: [
                    //full Name
                    TextFormField(
